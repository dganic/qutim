...
namespace qutim_sdk_0_3
{
	PluginInfoData::PluginInfoData()
	    : version(QUTIM_MAKE_VERSION(0, 0, 0, 1)), inited(0), loaded(0)
	{
	}
	...
	quint32 Plugin::makePluginVersion(quint8 major, quint8 minor, quint8 secminor, quint8 patch) const
	{
		return QUTIM_MAKE_VERSION(major, minor, secminor, patch);
	}
