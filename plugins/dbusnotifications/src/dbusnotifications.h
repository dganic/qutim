...
#ifndef DBUSNOTIFICATIONS_H_1330254587
#define DBUSNOTIFICATIONS_H_1330254587
...
public:
    DBusNotifications(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
namespace org {
  namespace freedesktop {
    typedef ::DBusNotifications Notifications;
  }
}
#endif
